...
class PostTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Thêm thẻ bài đăng thành công!');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Cập nhật thẻ bài đăng thành công');
        } else {
            request()->session()->flash('error', 'Hãy thử lại!');
        }
        return redirect()->route('post-tag.index');
    ...
    public function destroy($id)
    {
        ...
        if ($status) {
            request()->session()->flash('success', 'Xóa thẻ bài đăng thành công');
        } else {
