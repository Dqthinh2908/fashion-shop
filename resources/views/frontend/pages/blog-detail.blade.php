...
@section('title','Aristino | Trang chi tiết bài viết')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Danh mục bài viết</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> HOẶC <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> để bình luận.
