                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" placeholder="" value="{{@$user_profile->name}}">
                                            @error('first_name')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="" value="{{@$user_profile->email}}">
                                            @error('email')
                                                <span class='text-danger'>{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                @if(!empty($country_items))
                                                    @foreach($country_items as $country_code =>$country_item)
                                                    <option @if($country_code == 'VN') selected @endif value="{{@$country_code}}">{{@$country_item}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
