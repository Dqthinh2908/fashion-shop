								...
								@else
										<tr>
											<td class="text-center">
												Không có sản phẩm nào sẵn trong giỏ hàng. <a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua sắm</a>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn phải trả<span>{{number_format($total_amount,0)}} vnđ</span></li>
										@else
											<li class="last" id="order_total_price">Bạn phải trả<span>{{number_format($total_amount,0)}} vnđ</span></li>
										@endif
									</ul>
