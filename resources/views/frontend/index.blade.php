...
@section('title','Aristino | Trang chủ')
    ...
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item {{(($key==0)? 'active' : '')}}">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left" style="margin-bottom: -150px;">
                        <h1 style="color: #000;" class="wow fadeInDown">{{$banner->title}}</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="shop-section-title">
                            <h1>SẢN PHẨM TẢI LÊN GẦN ĐÂY</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
