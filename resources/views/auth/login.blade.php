...
<head>
  <title>Aristino | Trang đăng nhập</title>
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img width="110%" height="437" src="https://aristino.com/Data/ResizeImage/images/news/tin-tuc-aristino/uu-dai-den-50-reopening-showroom-aristino-dien-bienx750x750x4.webp" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
