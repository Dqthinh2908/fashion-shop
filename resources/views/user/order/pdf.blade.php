...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      <h4>ARISTINO</h4>
      <p>Phạm Hùng, Mỹ Đình, Nam Từ Liêm, Hà Nội, Vietnam</p>
      <p>Phone: (0123) 456 789 </a></p>
      <p>Email: aristino.vn@gmail.com</p>
    </div>
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      <h3>Invoice for #{{$order->cart_id}}</h3>
    ...
    <table class="table table-bordered table-stripe">
      ...
      <tfoot>
        ...
        <tr>
          ...
          <th><span>{{number_format($order->delivery_charge,0)}} vnd</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
  ...
  <div class="authority float-right mt-5">
    <p>-----------------------------------</p>
    <h5>Signature of authorized person:</h5>
  </div>
  <div class="clearfix"></div>
@else
  <h5 class="text-danger">Invalid signature</h5>
@endif
</body>
</html>
